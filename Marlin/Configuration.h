/**
 * carrega lcd fucinado marlin 2.4
...
//===========================================================================
#define CUSTOM_MACHINE_NAME "Z9M3-AG"
#define FIRMWARE_VERSION "V5.0"
#define STRING_DISTRIBUTION_DATE "2020-07-01"
#define EEPROM_VERSION "V77"                          //modify it if need reload EEPROM
#define STRING_CONFIG_H_AUTHOR "(ALEXSANDRO, Hally )" // Who made the changes.
...
Description:
  ...
  If you only changed two (X, Y), we suggest you modify the motor wires
  (1A and 1B)
*/
//#define	OPTION_DM2208  //Remove the "//" to enable it
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
...
/*
Description:
  In the older version, Z9 use a normal extruder part, from 2020-05, we have
  upgrade it to a Titan exturder, by using Titan extuder, it can provide more
  torque to extruder.
  After enable Titan extruder, we need to modify the extruder motor direction
  and change the e-steps/mm parameter to about 420.
  
*/
//#define	OPTION_TITAN  //Remove the "//" if you used it
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
...
/* 
Description:
    Hardware: TFT-LCD screen use EXP1 connector pins of +5/GNG/D16/D17, 
    it is connected to UART2 of ATMEGA2560
    D16=TXD2 
    D17=RXD2
*/
//#define	OPTION_TFTLCD  //Remove the "//" to enable it
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
...
/*
Description:
  Defaulf Z9 has a sync dula Z axis, it use only one Z drive motor, if you have 
  upgrade to dual Z motor drive, please open this option.
  Hardware:
  	Z2 motor connect to E0-MOT connector
  	Z2 ENDSTOP connect to Y-MAX connector
  	the 1st Extruder motor connect to E1-MOT connector
  	the 2nd Extruder motor connect to E2-MOT connector
  	the 3rd Extruder motor connect to E3-MOT connector
*/
//#define	OPTION_DUALZ  //Remove the "//" to enable it
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&

//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
//3D touch Leveling sensor
/*
Description:
  Defaulf Z9 use a proximity sensor as a bed leveling sensor, if you upgrade it
  to BLtouch or 3D touch, please open this option
  Hardware:
  D4 - SERVO PIN
  Z+ - Probe Pin
  
*/
//#define	OPTION_3DTOUCH  //Remove the "//" to enable it
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&

//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
//Power off after printer
/*
Description:
...
*/
//#define	OPTION_AUTOPOWEROFF  //Remove the "//" to enable it
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
...
/*
Description:
  if you need to set the hotbed and hotend to higher temperature, please enable this option
  HOTEND -  300 degree max
  HOTBED -  130 degree max
*/
//#define	OPTION_HIGHTEMP  //Remove the "//" to enable it
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
 ...
 */
#ifdef OPTION_TFTLCD
#define SERIAL_PORT 2 //D16=TXD2 D17=RXD2
#endif
 ...
 *   - This implementation supports up to four mixing extruders.
...
#define USE_PRECENT_MIXDATA     // Use os dados percentuais de mixagem na configuração do LCD e no comando gcode
#define MIX_STATUS_SCREEN_IMAGE // show mix rate ICON and data in LCD (only applied in LCD12864)
#if ENABLED(MIX_STATUS_SCREEN_IMAGE) && DISABLED(CUSTOM_STATUS_SCREEN_IMAGE) && DISABLED(OPTION_TFTLCD)
#define CUSTOM_STATUS_SCREEN_IMAGE
#endif
...
// ZONESTAR HE-M3-24V60W
//#define DEFAULT_Kp 36.31
//#define DEFAULT_Ki 2.52
//#define DEFAULT_Kd 130.88

// ZONESTAR HE-M3-24V50W
...
#ifdef OPTION_TITAN
#define EXTRUDER_DIR true
#else
#define EXTRUDER_DIR false
#endif
 ...
 */
#define Z_PROBE_END_SCRIPT "G1 X155 Y154 F9000\nG1 Z3 F100"
...
//#define EDITABLE_SERVO_ANGLES teste
