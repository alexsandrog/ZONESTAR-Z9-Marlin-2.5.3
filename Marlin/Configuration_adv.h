...
#define NUM_Z_STEPPER_DRIVERS 1   // (1-4) Z options change based on how many
  ...
  //#define Z_MULTI_ENDSTOPS
    ...
    //#define Z2_MIN_PIN	   	   	Z2_SW_PIN	//If use Z2_SW_PIN as Z2 ENDSTOP, enable this option
    #define Z2_USE_ENDSTOP          _YMAX_		//If use Y_MAX_PIN as Z2 ENDSTOP, enable this option
 ...
 */
   ...
   */
    ...
    // The normal delay is 10us. Use the lowest value that still gives a reliable display.
...
#define FWRETRACT
  ...
  #define RETRACT_LENGTH_SWAP 	8         	// (mm) Default swap retract length (positive value)
